    ...
    <div class="flex h-screen">
        ...
        <div class="w-60 bg-gray-800 text-white flex flex-col fixed h-screen">
            ...
            <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-2">
                ...
                <a href="{{ route('admin.pengunjung.index') }}" class="flex items-center px-4 py-2 rounded text-sm font-semibold {{ request()->routeIs('admin.pengunjung.index') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.pengunjung.grafik') }}" class="flex items-center px-4 py-2 rounded text-sm font-semibold {{ request()->routeIs('admin.pengunjung.grafik') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18h18"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17l3-5 4 3"/>
                    </svg>
                    Grafik Kunjungan
                </a>
